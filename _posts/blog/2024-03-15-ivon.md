...
<img src="/assets/images/ivonblog/gpt2.png" alt="IVON improves over AdamW on GPT-2" style="height: 300px;"/>
</div>
<br>
...
<div style="text-align: center;"> 
<img src="/assets/images/ivonblog/imagenet.png" alt="IVON improves over AdamW on ImageNet" style="height: 300px;"/>
</div>
<br>
...
We could have probably written a paper back then hastily, but we took almost 3 years to make sure to do this properly. Essentially, we had to find tricks that will work for most popular benchmarks and convince ourselves that this is really a good optimizer that gives us a reasonable posterior distribution as well as an estimate of the Hessian.

We find overwhelming evidence that IVON is a good optimizer, as good as any other optimizer that exists. We hope that the community will benefit from this work. For us, this is an important milestone because, we believe that, IVON enables us to tackle the problem of knowledge understanding, transfer and collection. In coming years, we hope to have many new advances working towards an AI that can do continual lifelong learning just like we do.
