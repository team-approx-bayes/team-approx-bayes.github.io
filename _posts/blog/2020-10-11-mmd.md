...
{\bf THE SHORTEST CONSISTENCY PROOF EVER?}
...
$$
\mathbb{E} \left[ d_k\left(\hat{P}_n,P^0 \right)\right]
 \leq \sqrt{\mathbb{E} \left[d_k^2\left(\hat{P}_n,P^0 \right)\right]}
$$
so let us just focus on bounding the expected square distance. Using the definition of the MMD distance,
$$
\mathbb{E} \left[d_k^2\left(\hat{P}_n,P^0 \right)\right]
...
{\bf HOW TO COMPUTE THE MMD-ESTIMATOR}
...
[4] P. Alquier and M. Gerber (2020). Universal Robust Regression via Maximum Mean Discrepancy. Preprint arxiv:2006.00840. The R package should be available in the next few months.
...
[7] Y. G. Yatracos (1985). Rates of convergence of minimum distance estimators and Kolmogorov's entropy. The Annals of Statistics, 768-774.

[8] Y. Baraud, L. Birg\'e and M. Sart (2017). A new method for estimation and model selection: ρ-estimation. Inventiones mathematicae.

[9] L. Devroye and G. Lugosi (2001). Combinatorial methods in density estimation. Springer.

[10] K. Muandet, K. Fukumizu, B. Sriperumbudur and B. Sch\"olkopf, (2017). Kernel mean embedding of distributions: A review and beyond. Foundations and Trends in Machine Learning, 10(1-2), 1-141.
...
[12]  F.-X. Briol, A. Barp, A. B. Duncan and M. Girolami (2019). Statistical Inference for Gen erative Models via Maximum Mean Discrepancy. Preprint arXiv:1906.05944.
